...
import { createPoll, getPollAnalytics, getPollById, getPolls, respondToPoll } from '../controllers/pollController.js';
...
router.get('/:id/analytics', requireSchoolActive, getPollAnalytics);
