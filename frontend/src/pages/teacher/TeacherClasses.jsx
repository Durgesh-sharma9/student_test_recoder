    ...
    <PageStack>
      ...
      {groupedAssignments.length === 0 ? (
        <ErpSection title="Assignments" icon={GraduationCap} tone="green">
          <div className="py-6 text-center rounded-lg border border-blue-100 bg-gradient-to-br from-blue-50/50 to-white">
        ...
        <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {groupedAssignments.map((assignment, idx) => (
            <div
              key={idx}
              className="group flex flex-col overflow-hidden rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50/40 shadow-sm transition-all duration-200 hover:border-blue-300 hover:shadow"
            >
              ...
              <div className="flex flex-col flex-1 p-3.5">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex h-9 w-9 items-center justify-center rounded-md bg-white border border-blue-100/50 shrink-0 transition-colors group-hover:bg-blue-50/80">
                ...
                <div className="mt-3 flex items-center justify-between border-t border-blue-100/50 pt-3">
