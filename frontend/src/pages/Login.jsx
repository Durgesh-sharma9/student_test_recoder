    ...
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 md:p-6">
      ...
      <div className="relative z-10 flex w-full max-w-6xl items-center justify-center lg:justify-between gap-12">
        ...
        <div className="w-full max-w-[400px] rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl sm:p-9">
          ...
          <h3 className="mb-1.5 text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">Welcome Back 👋</h3>
          <p className="mb-7 text-sm text-slate-500">Login to continue to your dashboard</p>
          ...
          <Button
            ...
            onClick={() => {
              ...
              window.location.href = base.endsWith('/api') ? `${base}/auth/google` : `${base}/api/auth/google`;
            }}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <FormField label="Email Address">
              <div className="relative">
                ...
                <Input type="email" className="pl-10" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} required />
              </div>
            </FormField>
