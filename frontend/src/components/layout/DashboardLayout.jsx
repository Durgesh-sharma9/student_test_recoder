...
import { LayoutDashboard, Users, School, GraduationCap, ClipboardList, ChartColumn, LogOut, Menu, X } from 'lucide-react';
...
const navByRole = {
  admin: [
    ...
    { to: '/admin/assignments', label: 'Teacher Assignment', icon: ClipboardList },
    { to: '/admin/results', label: 'Result Management', icon: ChartColumn },
  ],
  teacher: [
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      <aside className={cn('fixed inset-y-0 left-0 z-40 w-72 border-r bg-white transition-transform lg:static lg:translate-x-0', open ? 'translate-x-0' : '-translate-x-full')}>
        <div className="h-16 border-b px-4 flex items-center font-semibold">School Result System</div>
