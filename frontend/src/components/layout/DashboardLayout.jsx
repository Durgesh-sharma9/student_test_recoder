...
const navByRole = {
  ...
  parent: [
    ...
    { to: '/parent/attendance', label: 'Attendance', icon: UserCheck, iconColor: 'text-emerald-600', boxBg: 'bg-emerald-50 group-hover:bg-emerald-100', featureKey: 'parent_portal' },
